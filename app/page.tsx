...
import { Calendar, MapPin, Clock, Users, Star, ArrowRight, Music, Sparkles } from 'lucide-react'
  ...
  loading: () => (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-lg p-6">
        ...
        <p className="mt-2 text-sm text-gray-600">Loading ticket selector...</p>
      </div>
    </div>
  ),
  ssr: false
...
export default function Home() {
  ...
  // Force animations to show after a delay if they don't trigger
  React.useEffect(() => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 sm:pt-20">
        ...
        <div id="main-content" className={`relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl lg:max-w-5xl mx-auto ${isLoaded ? 'force-visible' : ''}`}>
          ...
          <motion.div
            ...
            className="space-y-8"
            style={isLoaded ? { opacity: 1, transform: 'translateY(0)' } : {}}
          >
            {/* Host Badge */}
            <motion.div
            ...
            >
              ...
              {/* Main Title */}
              <h1
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-tight relative z-10"
                style={{
                  textShadow: '2px 2px 4px rgba(0,0,0,0.8), 0 0 20px rgba(0,0,0,0.8), 0 0 40px rgba(0,0,0,0.6)'
                }}
              >
                {eventDetails.title}
              </h1>
            ...
            <motion.p
              ...
              className="text-base sm:text-lg md:text-xl lg:text-2xl text-white max-w-2xl sm:max-w-3xl mx-auto font-semibold leading-relaxed px-4"
              style={{
                textShadow: '1px 1px 3px rgba(0,0,0,0.9), 0 0 15px rgba(0,0,0,0.8)'
              }}
            >
            ...
            >
              <div className="flex items-center bg-black/60 backdrop-blur-sm px-4 sm:px-6 py-2 sm:py-3 rounded-full border-2 border-white/50">
            ...
            <motion.button
              ...
              className="btn-primary text-base sm:text-lg px-6 sm:px-8 lg:px-10 py-3 sm:py-4 flex items-center mx-auto shadow-2xl focus:outline-none focus:ring-4 focus:ring-pink-300 focus:ring-offset-2"
              tabIndex={0}
            >
            ...
            <div id="ticket-description" className="sr-only">
              Click to open ticket selection modal for Rangtaali Hamilton 2025 event
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className={`section-padding ${isLoaded ? 'force-visible' : ''}`}>
